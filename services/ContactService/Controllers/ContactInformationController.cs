...
namespace ContactService.Controllers
{
    ...
    public class ContactInformationController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<ContactInformationReadDto>> GetContactInformationForContact(Guid contactUuid)
        {
            ...
            var contacts = _contactInformationRepository.GetContactInformationByContactId(contactUuid);

            return Ok(_mapper.Map<IEnumerable<ContactInformationReadDto>>(contacts));
        }
        
        [Route("GetAllContactInformation")]
        [HttpGet]
        public ActionResult<IEnumerable<ContactInformationReadDto>> GetAllContactInformation()
        {
 
            var contacts = _contactInformationRepository.GetAll();
